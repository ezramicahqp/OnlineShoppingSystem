...
public class cartPageProd4 extends JFrame{

    public cartPageProd4(){
       //PANELS
       ...
       //FRAME 
        ...
        ImageIcon product = new ImageIcon(new ImageIcon("shoes.png").getImage().getScaledInstance(130, 130, Image.SCALE_DEFAULT));
